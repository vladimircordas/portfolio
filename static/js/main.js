...
$(document).ready(function() {
    $("#about-btn, #omeni-btn").click(function(e) {
    ...
    $("#mywork-btn, #mojiradovi-btn").click(function(e) {
        e.preventDefault();
        $('html, body').stop().animate({
            scrollTop: $("#work").position().top - 80
        }, 800);
    });
    $("#contact-us-btn, #kontakt-btn").click(function(e) {
        e.preventDefault();
        $('html, body').stop().animate({
            scrollTop: $("#contactme").position().top - 80
        }, 800);
    });
    $("#intro-btn, #uvod-btn").click(function(e) {
        e.preventDefault();
        $('html, body').stop().animate({
            scrollTop: $("body").position().top
        }, 800);
    });
    $("#get-in-touch-btn, #get-in-touch-btn-srb").click(function(e) {
        e.preventDefault();
        $('html, body').stop().animate({
...
$(document).ready(function(){
    $("input, textarea").focus(function(){
        $(this).next(".control-label").addClass('focused');
    });
    $("input, textarea").blur(function(){
        $(this).next(".control-label").removeClass('focused');
    });
    $(".menu-buttons.lng-eng, .menu-buttons.lng-srb, .musicButtons, .social li").click(function (e) {
...
$(document).ready(function(){
    ...
    if ((old_ie > -1) || (new_ie > -1)) {
        $('#intro, #intro-btn, #uvod-btn').remove();
        $('#bs-example-navbar-collapse-1 li').eq(0).remove();
        $('#about').css('margin-top', 50);
        $('#bs-example-navbar-collapse-1 li').css("width", "calc(100% / 4)");
    }
